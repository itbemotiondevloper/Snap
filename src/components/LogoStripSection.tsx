  ...
  if (name === "better") {
    return (
      <span className="inline-flex items-center gap-2 text-left whitespace-nowrap text-[#2f2d29] dark:text-white">
        <span className="grid size-7 place-items-center rounded-full bg-[#34312c] dark:bg-white text-[#ffffff] dark:text-[#050814]">
  ...
  return (
   <span className="inline-flex items-center gap-2 whitespace-nowrap text-[14px] font-bold text-[#2f2d29] dark:text-white">
      <span className="relative size-5">
        ...
        <span className="absolute left-2 top-2 size-2 rounded-full border-2 border-current bg-[#ffffff]" />
      </span>
      Designer Fund
    </span>
  );
...
export function LogoStripSection() {
  return (
    <motion.section
      className="theme-section overflow-hidden border-y border-[#191919]/10 dark:border-white/10 bg-[#ffffff] dark:bg-[#050814] py-6 sm:py-8"
